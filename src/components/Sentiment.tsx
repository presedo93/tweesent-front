...
const Sentiment = (props: SentimentProps) => {
    ...
    const bg = (): string => {
        if (props.sentiment === 'negative') return 'border-red-500 text-red-500'
        ...
        <>
            ...
            <Row>
                <Col
                    md={{ span: 10, offset: 1 }}
                    className={
                        'h-16 rounded-lg border-2 flex justify-center items-center ' + bg()
                    }
                >
            ...
            <Row>
                <Col
                    md={{ span: 10, offset: 1 }}
                    className={'overflow-y-auto rounded-lg h-[42rem] ' + bgcolor}
                >
